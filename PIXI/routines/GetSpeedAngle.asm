; routine to get x and y speeds based on x and y distances + base speed
; input:	A   = base speed
;			$00 = x distance (= sprite x minus target x) (16-bit)
;			$02 = y distance (= sprite x minus target x) (16-bit)
; output:	$00 = x speed
;			$02 = y speed
