; 2x2 tile block platform sprite that Mario can grab a throwblock from and is solid for other sprites
...
.typeset
	...
	LDA #$20 : STA $7FB618,X	; sprite hitbox width for interaction with Mario (vanilla flying item block = #$0D)
...
.tileloop
	...
	LDA #%00100111				; tile YXPPCCCT properties
	ORA $64
	STA $0303,Y
