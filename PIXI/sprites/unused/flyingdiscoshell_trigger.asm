; flying disco shell (no gravity) with animated wings that tracks Mario horizontally and moves up or down based on the on/off state
...
.DontSetHorizSpeed
	...
	LDY $14AF					; load the on/off state into Y
	BNE .MoveUp					; if on, go to .MoveUp
	CMP #!MaxDownSpeed			; if off, if the y speed is below the max speed, increase the y speed by 2
...
.DontSetVertSpeed
	JSL $018022					; update sprite's horizontal position without applying gravity
