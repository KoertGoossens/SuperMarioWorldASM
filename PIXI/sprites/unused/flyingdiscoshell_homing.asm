; flying disco shell (no gravity) with animated wings that homes in onto you (with both horizontal and vertical tracking) and gets a downward boost when bouncing off it
