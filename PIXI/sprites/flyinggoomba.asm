; flying goomba with wings that can be jumped off to stun it; it can float in place, or move linearly based on the extension bytes
...
; GOOMBA GRAPHICS
	...
	LDA #%00000101				; tile YXPPCCCT properties
	PHY
