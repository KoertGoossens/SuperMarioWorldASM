...
; the second extension byte determines the type:
;	+01 = chases Mario
;	+02 = single bounce
...
SpriteCode:
	...
	LDA $15AC,X					; if set to interact with blocks, process interaction with blocks
	BNE +
	JSL $019138
	+
...
NormalInteraction:
	...
	LDA $7FAB4C,X				; if the bounce type is 'infinite'...
	AND #%00000010
	BNE +
	...
	%HandleBounceCounter()		; else (the bounce type is 'single')...
...
Tilemap:
	db $82,$80
TileProp:
	db %00101000,%00100100,%00101100,%00101100
