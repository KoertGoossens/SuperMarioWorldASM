; flying bob-omb with wings that can be jumped off to stun it; it can float in place, or move linearly based on the extension bytes
...
HitEnemy_Bomb:		%HandleSlideHurt() : RTS
