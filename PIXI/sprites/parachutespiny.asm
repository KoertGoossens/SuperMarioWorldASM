; spiny hanging from a parachute; it will drop a regular spiny if Mario gets horizontally close
...
HandleDropSprite:
	LDA #$35					; handle dropping a spiny sprite
	STA $0F
	%HandleParachuteSprite()
	LDA #$00					; set the spiny's x speed to 0
	STA $7FAB40,X
	RTS
...
; spiny tile
	...
	LDA #%00101000				; load tile YXPPCCCT properties
	ORA $64
	STA $0303,Y
