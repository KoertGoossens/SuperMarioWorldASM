; custom throwblock sprite that does not melt
...
InitCode:
	...
	LDA #$0E : STA $7FB618,X	; sprite hitbox width for interaction with Mario
	...
	LDA #$0F : STA $7FB654,X	; sprite hitbox height for interaction with other sprites
...
.bonkwall
	JMP Cnt_SolidSprite_Side		; handle sideways interaction
...
BounceThrowblockSpriteList:
	...
	db $01,$01,$00,$01,$00,$00,$01,$00,$01,$00,$01,$00,$00,$00,$00,$00		; 60 = solid block, 61 = death block, 63 = item block, 66 = used block, 68 = eating block, 6A = walking block
	db $01,$01,$00,$00,$00,$00,$00,$00,$01,$00,$00,$00,$00,$00,$00,$00		; 70 = big block, 71 = big death block, 78 = sticky block

Cnt_SolidSprite_Side:
	LDA #$01						; play bonk sfx
	STA $1DF9
	
	%SolidSprite_Activate()			; check for block activation
	
	PHX								; if the block sprite is set to bounce throwblocks rather than break them...
	TYX
	LDA $7FAB9E,X
	TAX
	LDA BounceThrowblockSpriteList,X
	BEQ +
	...
	PLX
	JSR BreakThrowBlock				; else, break the throwblock
	RTS
...
ShatterTiles:	%SpawnShatterTiles() : RTS