; flying buzzy beetle with wings that can be jumped off to stun it; it can float in place, or move linearly based on the extension bytes
...
BounceMarioNormal:
	...
	LDA $7FAB58,X				; transfer the stun timer property
	STA $7FAB4C,X
	RTS
...
; BUZZY BEETLE GRAPHICS
	LDA $00						; tile x position
	STA $0300,Y
	
	LDA $01						; tile y position
	PHY
	LDY $02						; raise the tile 1 pixel based on the animation frame
	BNE +
	DEC
	+
	PLY
	...
	LDA #%00000111				; tile YXPPCCCT properties
	PHY
