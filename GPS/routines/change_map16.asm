; note by Katun24:	This code changes the Map16 id of the block located at the clipping points $98 through $9B.
;					Because of these addresses, it only works properly when Mario touches the block.
;					For sprites touching the block, run %sprite_block_position() before calling %change_map16
