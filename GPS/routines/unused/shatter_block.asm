;The original one had a bug where if you place this in a vertical level, the shatter
;pieces are in the wrong location. Paste this in GPS's "routines" folder.

    PHY        ;>Protect tile behavior
    ...
    STY $99        ;|levels!!!!! (borrowed from the map16 change routine of GPS).
    STA $9B        ;/
?+
