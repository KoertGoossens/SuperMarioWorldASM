...
MarioTouch:
	LDA #!speed_x				; give Mario leftward speed
	STA $7B
	LDA #!speed_y				; give Mario upward speed
	STA $7D
	
	JMP EraseBlock

SpriteTouch:
	LDA #!speed_x				; give the sprite leftward speed
	STA $B6,X
	LDA #!speed_y				; give the sprite upward speed
	STA $AA,X
