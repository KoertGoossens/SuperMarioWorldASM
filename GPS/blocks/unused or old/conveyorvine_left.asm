; a climbable vine tile that pushes Mario to the left when climbing it; insert as 6
...
MarioTouch:
	...
	AND #%00000011
	BNE +
	LDA #$E8			; x speed when neutraling the dpad
	BRA SetSpeed
	+
	AND #%00000001
	BNE +
	LDA #$D8			; x speed when holding left
	BRA SetSpeed
	+
	LDA #$F8			; x speed when holding right
...
print "A conveyor vine that pushes Mario left when climbing it."