; this tile reflects a fireball vertically, so that it flies into the opposite y direction rather than being erased; insert it as 130 (solid)
...
FireballHit:
	LDA $173D,X				; invert fireball's y speed
	EOR #$FF
	INC A
	STA $173D,X
...
print "This block reflects a fireball vertically."