; this block inverts a kicked throwblock's horizontal speed when hit, rather than breaking it; insert as 25 (if inserted as 130 it will break against the tile regardless)
;
; code by Katun24
...
print "This block inverts a throwblock's horizontal speed when hit, rather than breaking it."