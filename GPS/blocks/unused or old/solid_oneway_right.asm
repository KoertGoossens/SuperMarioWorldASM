; this tile is solid except on the right side for sprites - use as a ceiling tile where you have to do uptosses, to prevent horizontal collision bugs; insert as 130
...
SpritePass:
	LDA $B6,x				; if the sprite is moving right, leave the tile as solid
	BPL Return
...
print "This block is solid except on the right side for sprites."