; a climbable vine tile that pushes Mario down when climbing it; insert as 6
...
MarioTouch:
	...
	AND #%00001100
	BNE +
	LDA #$18			; y speed when neutraling the dpad
	BRA SetSpeed
	+
	AND #%00000100
	BNE +
	LDA #$08			; y speed when holding up
	BRA SetSpeed
	+
	LDA #$28			; y speed when holding down
...
print "A conveyor vine that pushes Mario down when climbing it."