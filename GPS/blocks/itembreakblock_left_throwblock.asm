; this item block breaks when hit and spawns a throwblock; insert as 130
...
HitBlock:
	...
	%SpawnBlockSprite_Left()
	
	PHX
	LDX $08
	LDA #$D2							; give the throwblock leftward speed
	STA $B6,X
	LDA #$0A							; set the throwblock's sprite status to kicked (load after init)
	STA $1594,X
	PLX
