; a vertical climbable top vine tile; insert as 25
...
.checkgrab
	LDX #$01					; load 1 as a default 'on climbable surface' index
	
	LDA $98						; get the block's y position
	AND #%1111111111110000
	SEC : SBC $96				; subtract Mario's y position
	CMP #$0014					; if Mario is high enough...
	BCC +
	LDX #$02					; load 2 as the 'on climbable surface' index
	+
	...
	LDA $18BE					; and the 'on climbable surface' index is 1...
	CMP #$01
	BNE .skipstartclimb
