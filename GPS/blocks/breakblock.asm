; this block shatters when hit (interaction like a flipblock), or spun on by big Mario to destroy it; insert as 130

db $37
JMP HitBlock		; Mario touching the tile from below
