; this block behaves like a regular solid block, except throwblocks can bounce off on the side, and activating a coin/block p-switch turns it into a coin; insert as 130
