; this block drags Mario and sprites to the right when they're on it; insert as 130
...
MarioTop:
	REP #$20				; move Mario's x position 2 pixels to the right
	LDA $94
	CLC : ADC #$0002
	STA $94
	SEP #$20
...
SpriteTouch:
	LDA $14E0,X				; move the sprite's x position 2 pixels to the right
	XBA
	LDA $E4,X
	REP #$20
	CLC : ADC #$0002
